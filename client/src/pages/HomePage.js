...
const HomePage = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute("download", "last_month_report.xlsx");
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
      message.success("Monthly Report Downloaded Successfully")
    } catch (error) {
      console.error("Error exporting last month report:", error);
      message.error("Something went wrong exporting last month report");
    }
  };
